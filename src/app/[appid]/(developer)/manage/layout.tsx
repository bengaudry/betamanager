  ...
  return (
    <Link
      ...
      className={`${
        active
          ? "bg-white text-black"
          : "text-neutral-400 hover:bg-white/15 hover:text-white"
      } transition-colors rounded-lg px-4 py-2 font-medium text-nowrap`}
    >
      {title}
    </Link>
  );
...
const Navbar = () => {
  return (
    <nav className="navbar navbar-expand-lg navbar-light bg-light border-r border-neutral-700 h-screen py-8 px-4">
